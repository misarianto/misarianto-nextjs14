export default function Contact() {
    return (
      ...
      <img className="absolute top-0 left-0 md:mt-24" src="/dots-side-1.svg" alt="" />
      <img className="absolute bottom-0 right-0 mb-8 lg:mb-24" src="/dots-side-2.svg" alt="" />
      <div className="relative container px-4 mx-auto">
        <div className="max-w-2xl mx-auto mb-18 text-center">
          ...
          <h1 className="font-heading text-5xl xs:text-6xl font-bold  mb-4">
        ...
        <div className="flex flex-wrap justify-center -mx-4 mt-10">
          <div className="w-full md:w-1/2 lg:w-auto px-4 xl:px-10 mb-10 md:mb-0">
            <div className="max-w-sm mx-auto h-full py-8 px-6 border border-gray-200 rounded-3xl">
          ...
          <div className="w-full md:w-1/2 lg:w-auto px-4 xl:px-10">
            <div className="max-w-sm mx-auto h-full py-8 px-6 rounded-3xl border border-gray-200 rounded-5xl">
              <div className="max-w-2xs mx-auto text-center">
